...
export const AirportBookingManagement = () => {
  ...
  const [filteredBookings, setFilteredBookings] = useState(MOCK_AIRPORT_BOOKINGS);
  ...
  useEffect(() => {
    ...
    // Apply date filter
    if (dateFilter) {
      filtered = filtered.filter(booking => booking.arrivalDate === dateFilter);
    }
    ...
    setPage(0);
  }, [bookings, searchTerm, statusFilter, serviceFilter, dateFilter, sortConfig]);
  ...
  const validateForm = () => {
    ...
    if (!bookingForm.flightNumber.trim()) newErrors.flightNumber = 'Flight number is required';
    ...
    if (!bookingForm.arrivalTime) newErrors.arrivalTime = 'Arrival time is required';
    if (!bookingForm.airport.trim()) newErrors.airport = 'Airport is required';
    if (!bookingForm.serviceType) newErrors.serviceType = 'Service type is required';
    if (!bookingForm.numberOfPassengers) newErrors.numberOfPassengers = 'Number of passengers is required';
  ...
  const calculateTotalAmount = (formData) => {
    ...
    return (baseRate * passengerMultiplier * (bagMultiplier > 2 ? 1.2 : 1)).toFixed(2);
  };
  ...
  const Notification = () => {
    ...
    return (
      <div className={`fixed top-4 right-4 z-50 p-4 rounded-lg border ${bgColor} shadow-lg max-w-md transition-all duration-300`}>
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 bg-gray-50 min-h-screen">
      ...
      <div className={`grid ${getResponsiveGrid().default} ${getResponsiveGrid().sm} ${getResponsiveGrid().md} ${getResponsiveGrid().lg} gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 md:mb-8`}>
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg sm:rounded-xl p-4 sm:p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl md:text-3xl font-bold mt-1 sm:mt-2">{statistics.total}</p>
            </div>
        ...
        <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-lg sm:rounded-xl p-4 sm:p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl md:text-3xl font-bold mt-1 sm:mt-2">{statistics.pending}</p>
            </div>
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg sm:rounded-xl p-4 sm:p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl md:text-3xl font-bold mt-1 sm:mt-2">{statistics.confirmed}</p>
            </div>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg sm:rounded-xl p-4 sm:p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl md:text-3xl font-bold mt-1 sm:mt-2">${statistics.revenue.toLocaleString()}</p>
            </div>
      ...
      <div className="bg-white rounded-lg sm:rounded-xl shadow p-3 sm:p-4 md:p-5 mb-4 sm:mb-6">
        <div className="flex flex-col gap-3 sm:gap-4">
          ...
          <div className={`grid ${getResponsiveGrid().default} ${getResponsiveGrid().sm} ${getResponsiveGrid().md} gap-3`}>
            <div>
              <div className="relative">
          ...
          <table className="w-full min-w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {paginatedBookings.length === 0 ? (
                <tr>
                  <td colSpan="5" className="px-3 sm:px-4 md:px-6 py-8 sm:py-12 text-center text-gray-500">
                    <div className="flex flex-col items-center">
                      <FlightTakeoffIcon className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 text-gray-300 mb-3 sm:mb-4" />
                      <p className="text-base sm:text-lg md:text-xl font-medium text-gray-600">No airport bookings found</p>
                      <p className="text-gray-500 text-sm sm:text-base mt-1">Try adjusting your search or filter criteria</p>
                      <button
                        onClick={handleCreate}
                  ...
                  <tr key={booking.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-2 sm:ml-3 md:ml-4">
                          ...
                          <div className="text-xs sm:text-sm text-gray-500 flex items-center mt-0.5">
                            ...
                            <span className="truncate max-w-[120px] sm:max-w-[180px] md:max-w-none">{booking.email}</span>
                          </div>
                    ...
                    <td className="px-3 sm:px-4 md:px-6 py-4 hidden sm:table-cell">
                      ...
                      <div className="text-xs text-gray-500 mt-0.5">
                        {formatDateTime(booking.arrivalDate, booking.arrivalTime)}
                      </div>
                    </td>
                    <td className="px-3 sm:px-4 md:px-6 py-4 hidden md:table-cell">
                      ...
                      <div className="text-xs sm:text-sm text-gray-500 flex items-center mt-1">
                        ...
                        {booking.numberOfPassengers} passengers • {booking.numberOfBags} bags
                      </div>
                    </td>
                    <td className="px-3 sm:px-4 md:px-6 py-4">
          ...
          <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6">
                <div className="flex items-center">
                  <label htmlFor="rowsPerPage" className="text-xs sm:text-sm text-gray-700 mr-2 sm:mr-3">
                    Rows:
                  </label>
                  <select
                    id="rowsPerPage"
              ...
              <div className="px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 border-b border-gray-200 flex justify-between items-center bg-gradient-to-r from-gray-50 to-white">
                <div>
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">
                    {isEditMode ? 'Edit Airport Booking' : 'New Airport Booking'}
                  </h2>
                  <p className="text-gray-600 text-xs sm:text-sm mt-0.5">
                    {isEditMode ? 'Update booking information' : 'Fill in passenger and flight details'}
                  </p>
                </div>
                <button
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none text-sm sm:text-base ${
                            errors.flightNumber ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'
                          }`}
                          placeholder="WB 345"
                          disabled={isSubmitting}
                        />
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none text-sm sm:text-base ${
                            errors.airline ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'
                          }`}
                          disabled={isSubmitting}
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6 mt-3 sm:mt-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none text-sm sm:text-base ${
                            errors.arrivalTime ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'
                          }`}
                          disabled={isSubmitting}
                        />
                        {errors.arrivalTime && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none text-sm sm:text-base ${
                            errors.airport ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'
                          }`}
                          disabled={isSubmitting}
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6 mt-3 sm:mt-4">
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none text-sm sm:text-base ${
                            errors.serviceType ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'
                          }`}
                          disabled={isSubmitting}
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6 mt-3 sm:mt-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none text-sm sm:text-base ${
                            errors.numberOfPassengers ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'
                          }`}
                          disabled={isSubmitting}
                        />
        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-2 sm:p-3 md:p-4">
            <div className="bg-white rounded-lg sm:rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
              <div className="px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 border-b border-gray-200 flex justify-between items-center bg-gradient-to-r from-gray-50 to-white">
                <div>
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Booking Details</h2>
                  <p className="text-gray-600 text-xs sm:text-sm mt-0.5">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                    <div className="bg-blue-50 rounded-lg sm:rounded-xl p-3 sm:p-4">
                      <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Flight Information</h4>
                      <div className="space-y-1 sm:space-y-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-900">{selectedBooking.airline}</p>
                        </div>
                        <div>
                          <p className="text-xs text-gray-600">Arrival</p>
                          <p className="text-sm font-medium text-gray-900">
                            {formatDateTime(selectedBooking.arrivalDate, selectedBooking.arrivalTime)}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-green-50 rounded-lg sm:rounded-xl p-3 sm:p-4">
                      <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Service Details</h4>
                      <div className="space-y-1 sm:space-y-2">
                        <div>
                          <p className="text-xs text-gray-600">Service Type</p>
                          <p className="text-sm font-medium text-gray-900">
                            {SERVICE_TYPES.find(s => s.value === selectedBooking.serviceType)?.label}
                          </p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-900">{selectedBooking.terminal || 'N/A'}</p>
                        </div>
                      </div>
                    </div>
                    
                    <div className="bg-purple-50 rounded-lg sm:rounded-xl p-3 sm:p-4">
                      <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-2">Payment & Passengers</h4>
                      <div className="space-y-1 sm:space-y-2">
                        <div>
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-900 flex items-center">
                            ...
                            {PAYMENT_METHODS.find(p => p.value === selectedBooking.paymentMethod)?.label || selectedBooking.paymentMethod}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs text-gray-600">Passengers & Bags</p>
                          <p className="text-sm font-medium text-gray-900 flex items-center">
                            <GroupsIcon className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />
                  ...
                  {/* Additional Information */}
                  {(selectedBooking.specialRequirements || selectedBooking.additionalInfo || selectedBooking.emergencyContact) && (
                    <div className="bg-gray-50 rounded-lg sm:rounded-xl p-3 sm:p-4">
                      ...
                      <div className="space-y-3">
                        {selectedBooking.specialRequirements && (
                          <div>
                            <p className="text-xs text-gray-600">Special Requirements</p>
