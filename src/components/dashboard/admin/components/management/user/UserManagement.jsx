...
export const UserManagement = () => {
  ...
  const handleExportPDF = () => {
    try {
      ...
      const inactiveUsers = filteredUsers.filter(u => u.status !== 'active').length;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-2">User Management Dashboard</h1>
