...
//     if (!bookingForm.university.trim())
...
//           currency: "USD",
//           bookingReference: `BOOK-${String(bookings.length + 1).padStart(
//             3,
//             "0"
//           )}`,
...
//     return (
//       <span
//         className={`px-3 py-1 text-xs font-semibold rounded-full border ${colorClass}`}
//       >
...
//   return (
//     <div className="p-6 w-full flex bg-gray-50 min-h-screen">
...
//                 Manage accommodation bookings, track reservations, and handle
//                 guest information
//               </p>
//             </div>
//             <button
...
//                             (p) => p.value === booking.preferredPayment
//                           )?.label || booking.preferredPayment}
//                         </div>
//                       </td>
//                       <td className="px-6 py-4">
...
//                             {selectedBooking.numberOfOccupants === "1"
//                               ? "person"
//                               : "people"}
//                           </p>
//                         </div>
...
//                             {PAYMENT_OPTIONS.find(
//                               (p) =>
//                                 p.value === selectedBooking.preferredPayment
//                             )?.label || selectedBooking.preferredPayment}
//                           </p>
//                         </div>
//                       </div>
//                     </div>
...
//                         This action cannot be undone. All booking data including
...
// Mock data for demonstration
const MOCK_BOOKINGS = Array.from({ length: 25 }, (_, i) => ({
  id: i + 1,
  firstName: ["John", "Jane", "Alex", "Michael", "Sarah", "David"][i % 6],
  lastName: ["Doe", "Smith", "Johnson", "Brown", "Wilson", "Taylor"][i % 6],
  email: `user${i + 1}@example.com`,
  phone: `+250 78${String(Math.floor(Math.random() * 1000)).padStart(3, '0')} ${String(Math.floor(Math.random() * 10000)).padStart(4, '0')}`,
  university: ["University of Rwanda", "Kigali Institute of Science", "University of Kigali", "KIST", "Catholic University", "Mount Kenya University"][i % 6],
  course: ["Computer Science", "Business Administration", "Medicine", "Engineering", "Law", "Economics"][i % 6],
  arrivalDate: `2024-0${Math.floor((i % 12) / 2) + 1}-${String((i % 28) + 1).padStart(2, '0')}`,
  departureDate: `2024-0${Math.floor((i % 12) / 2) + 4}-${String((i % 28) + 1).padStart(2, '0')}`,
  numberOfOccupants: (i % 5 + 1).toString(),
  preferredPayment: ["bank_transfer", "credit_card", "paypal", "mobile_money", "cash"][i % 5],
  specialRequirements: i % 3 === 0 ? "Vegetarian meals required" : i % 3 === 1 ? "Need airport pickup" : "Need ground floor room",
  status: ["pending", "confirmed", "cancelled", "checked_in", "checked_out", "payment_pending"][i % 6],
  totalAmount: (Math.random() * 2000 + 500).toFixed(0),
  currency: "USD",
  createdAt: `2024-01-${String((i % 28) + 1).padStart(2, '0')}`,
  updatedAt: `2024-01-${String((i % 28) + 1).padStart(2, '0')}`,
  bookingReference: `BOOK-${String(i + 1).padStart(3, "0")}`,
}));
...
export const AccomodationBookingManagement = () => {
  ...
  // Render booking cards for grid view
        ...
        >
          <div className="p-4">
            <div className="flex justify-between items-start mb-3">
              <div className="flex items-center space-x-2">
                <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-400 rounded-xl flex items-center justify-center text-white font-bold">
                  {booking.firstName.charAt(0)}
                  {booking.lastName.charAt(0)}
                </div>
                <div>
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex items-center text-sm text-gray-600">
                ...
                <span className="truncate">{booking.university}</span>
              </div>
              <div className="flex items-center text-sm text-gray-600">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => handleView(booking)}
                className="text-sm bg-blue-50 text-blue-600 py-2 rounded-lg hover:bg-blue-100 transition-colors"
              >
                View
              </button>
              <button
                onClick={() => handleEdit(booking)}
                className="text-sm bg-green-50 text-green-600 py-2 rounded-lg hover:bg-green-100 transition-colors"
              >
                Edit
              </button>
            </div>
          ...
          {currentBookings.map((booking) => (
            <tr key={booking.id} className="hover:bg-gray-50 transition-colors">
              <td className="px-4 py-3">
                <div className="flex items-center">
                  <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-400 rounded-xl flex items-center justify-center text-white font-bold">
                    {booking.firstName.charAt(0)}
                    {booking.lastName.charAt(0)}
                  </div>
                  <div className="ml-3">
  ...
  return (
    <div className="min-h-screen w-full flex bg-gray-50">
      ...
      <div className="w-full p-2 sm:p-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600">
                Manage accommodation bookings, track reservations, and handle guest information
              </p>
            </div>
            <button
              onClick={handleCreate}
              className="flex items-center justify-center w-full sm:w-auto px-4 py-2.5 sm:px-5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 shadow-lg hover:shadow-xl transition-all text-sm sm:text-base"
            >
        ...
        {/* Statistics Cards */}
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6">
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-4 sm:p-6 text-white shadow-lg">
            <div className="flex items-center justify-between">
              ...
              <HotelIcon className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 opacity-80" />
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl p-4 sm:p-6 text-white shadow-lg">
            <div className="flex items-center justify-between">
              ...
              <ScheduleIcon className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 opacity-80" />
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-4 sm:p-6 text-white shadow-lg">
            <div className="flex items-center justify-between">
              ...
              <CheckIcon className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 opacity-80" />
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-4 sm:p-6 text-white shadow-lg">
            <div className="flex items-center justify-between">
              ...
              <MoneyIcon className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 opacity-80" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow p-4 sm:p-5 mb-4 sm:mb-6">
          <div className="flex flex-col md:flex-row gap-3 sm:gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full pl-9 sm:pl-12 pr-3 sm:pr-4 py-2 sm:py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-sm sm:text-base"
                />
              </div>
            </div>
            ...
            <div className="flex gap-2 sm:gap-3">
              ...
              <div className="relative flex-1 sm:flex-none sm:w-40 lg:w-48">
                <FilterIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4 sm:w-5 sm:h-5" />
                <select
                  value={statusFilter}
                  onChange={(e) => setStatusFilter(e.target.value)}
                  className="w-full pl-9 sm:pl-12 pr-3 sm:pr-4 py-2 sm:py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none appearance-none bg-white text-sm sm:text-base"
                >
                  <option value="all">All Status</option>
                  {STATUS_OPTIONS.map((status) => (
                    <option key={status.value} value={status.value}>
              ...
              <button
                ...
                className="flex items-center px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-xl text-gray-700 hover:bg-gray-50 transition-colors text-sm sm:text-base"
              >
        ...
        <div className="bg-white rounded-xl shadow overflow-hidden">
          ...
          {currentBookings.length === 0 ? (
            <div className="px-6 py-16 text-center text-gray-500">
              <div className="flex flex-col items-center">
                <HotelIcon className="w-12 h-12 sm:w-16 sm:h-16 text-gray-300 mb-4" />
                ...
                <button
                  onClick={handleCreate}
                  className="mt-4 sm:mt-6 px-4 sm:px-5 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 shadow-md text-sm sm:text-base"
                >
                  Create New Booking
                </button>
              </div>
      ...
      {openDialog && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-2 sm:p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl lg:max-w-4xl max-h-[90vh] overflow-hidden">
              <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-b border-gray-200 flex justify-between items-center bg-gradient-to-r from-gray-50 to-white">
                <div>
              ...
              <div className="p-4 sm:p-6 lg:p-8 overflow-y-auto max-h-[calc(90vh-6rem)]">
                <form onSubmit={handleBookingSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                        ...
                        <input
                          ...
                          value={bookingForm.firstName}
                          onChange={handleInputChange}
                          className={`w-full px-3 sm:px-4 py-2 sm:py-3 border-2 rounded-xl focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none text-sm sm:text-base ${
                            errors.firstName
                              ? "border-red-500"
                              : "border-gray-300 focus:border-blue-500"
                          }`}
                  ...
                  <div className="border-b pb-6">
                    <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-4 flex items-center">
                      <SchoolIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-green-500" />
                      University Information
                    </h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                  ...
                  <div className="border-b pb-6">
                    <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-4 flex items-center">
                      <HotelIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-purple-500" />
                      Stay Information
                    </h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-4 sm:mt-6">
                      <div>
                        ...
                        <select
                          ...
                          value={bookingForm.numberOfOccupants}
                          onChange={handleInputChange}
                          className="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none text-sm sm:text-base"
                          disabled={isSubmitting}
                        >
                          {OCCUPANTS_OPTIONS.map((option) => (
                            <option key={option.value} value={option.value}>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      value={bookingForm.specialRequirements}
                      onChange={handleInputChange}
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 outline-none resize-none text-sm sm:text-base"
                      placeholder="Any special requirements, accessibility needs, or preferences..."
                      disabled={isSubmitting}
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className={`w-full py-3 sm:py-4 rounded-xl font-bold transition-all duration-300 flex items-center justify-center text-sm sm:text-base ${
                      isSubmitting
                        ? "bg-gray-400 cursor-not-allowed"
                        : "bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 hover:shadow-xl shadow-lg"
                    } text-white`}
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        {isEditMode ? (
                          <>
                            <SaveIcon className="w-4 h-4 sm:w-6 sm:h-6 mr-2 sm:mr-3" />
                            Update Booking
                          </>
                        ) : (
                          "Submit Booking Request"
        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-2 sm:p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl lg:max-w-4xl max-h-[90vh] overflow-hidden">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
                    <div className="flex items-center space-x-4 sm:space-x-6">
                      <div className="flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl flex items-center justify-center text-white text-xl sm:text-2xl font-bold">
                        {selectedBooking.firstName.charAt(0)}
                        {selectedBooking.lastName.charAt(0)}
                      </div>
                      <div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6 mt-1 sm:mt-2 space-y-2 sm:space-y-0">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 sm:p-6">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-sm sm:text-lg font-semibold text-gray-900 flex items-center">
                            <CalendarIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-blue-500 flex-shrink-0" />
                            {new Date(
                              selectedBooking.arrivalDate
                            ).toLocaleDateString("en-US", {
                              weekday: "short",
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 sm:p-6">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-sm sm:text-lg font-semibold text-gray-900 flex items-center">
                            <SchoolIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-green-500 flex-shrink-0" />
                            <span className="truncate">{selectedBooking.university}</span>
                          </p>
                        </div>
                        <div>
                          <p className="text-xs sm:text-sm text-gray-600">
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 sm:p-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm sm:text-lg font-semibold text-gray-900 flex items-center">
                            <PaymentIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-purple-500 flex-shrink-0" />
                            {PAYMENT_OPTIONS.find(
                              (p) =>
                                p.value === selectedBooking.preferredPayment
                            )?.label || selectedBooking.preferredPayment}
                  ...
                  {selectedBooking.specialRequirements && (
                    <div className="bg-gray-50 rounded-xl p-4 sm:p-6">
                      <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 flex items-center">
                        <StarIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-yellow-500" />
                        Special Requirements
                      </h4>
                      <p className="text-gray-700 whitespace-pre-line bg-white p-3 sm:p-4 rounded-lg border border-gray-200 text-sm sm:text-base">
                        {selectedBooking.specialRequirements}
                      </p>
                    </div>
                  )}
              ...
              <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-t border-gray-200 flex flex-col sm:flex-row justify-between gap-3 sm:gap-0">
                <div className="flex flex-wrap gap-3">
                  <button
                    ...
                    className="flex-1 sm:flex-none px-4 sm:px-5 py-2.5 sm:py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl hover:from-green-700 hover:to-green-800 shadow-md flex items-center justify-center transition-all text-sm sm:text-base"
                  >
                  ...
                  <button
                    onClick={() => handleStatusClick(selectedBooking)}
                    className="flex-1 sm:flex-none px-4 sm:px-5 py-2.5 sm:py-3 border-2 border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50 transition-colors flex items-center justify-center text-sm sm:text-base"
                  >
                ...
                <button
                  onClick={handleCloseViewDialog}
                  className="px-4 sm:px-5 py-2.5 sm:py-3 border-2 border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 transition-colors text-sm sm:text-base"
                >
                  Close
                </button>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md">
              <div className="p-6 sm:p-8">
                ...
                <div className="bg-red-50 border border-red-200 rounded-xl p-4 sm:p-5 mb-4 sm:mb-6">
                  <div className="flex">
                    <ErrorIcon className="w-5 h-5 sm:w-6 sm:h-6 text-red-500 flex-shrink-0 mt-0.5" />
                    <div className="ml-3">
                ...
                <div className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4">
                  ...
                  <button
                    onClick={handleDelete}
                    disabled={loading}
                    className="px-4 sm:px-5 py-2.5 sm:py-3 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl hover:from-red-700 hover:to-red-800 shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transition-all text-sm sm:text-base"
                  >
                    {loading ? (
                      <>
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  {STATUS_OPTIONS.map((status) => (
                    <button
                      ...
                      className={`w-full p-3 sm:p-4 rounded-xl border-2 transition-all flex items-center justify-between text-sm sm:text-base ${
                        selectedBooking.status === status.value
                          ? "border-blue-500 bg-blue-50"
                          : "border-gray-200 hover:border-blue-300 hover:bg-blue-50"
                      }`}
