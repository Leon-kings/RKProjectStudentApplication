                ...
                <div className="flex flex-col lg:flex-row justify-between items-center">
                  <div className="mb-4 lg:mb-0 text-center lg:text-left">
                    ...
                    <p className="opacity-90">
                      Download {timeRange} reports for analysis
                    </p>
                  </div>
                  <div className="flex flex-col xs:flex-row gap-4">
                    ...
                    <button
                      onClick={() => handleExportData("csv")}
                      className="px-6 py-3 bg-transparent border border-white text-white font-bold rounded-xl hover:bg-white/10 transition-colors"
                    >
                      <DownloadForOfflineIcon className="h-5 w-5 inline mr-2" />
                      Export CSV Data
                    </button>
