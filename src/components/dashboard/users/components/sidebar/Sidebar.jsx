      ...
      >
        <div className="flex items-center justify-center w-8 h-8 min-w-[2rem]">
          <motion.span
            ...
            className={`${activeSection === item.id ? 'text-white' : 'text-gray-500 group-hover:text-blue-600'}`}
          >
            {item.icon}
          </motion.span>
        </div>
      ...
      <motion.aside
        ...
        animate={
          window.innerWidth < 768
            ? (isMobileOpen ? "mobileExpanded" : "mobileHidden")
        ...
        `}
        style={{
          width: window.innerWidth < 768 ? '260px' : isCollapsed ? '70px' : '260px'
        }}
      >
        {/* Header */}
          ...
          <div className="flex items-center justify-between p-4">
            {(!isCollapsed || isMobileOpen) ? (
              ...
              >
                ...
                >
                  <h1 className="text-xl font-bold text-gray-900 dark:text-white">RECAPPLY</h1>
              ...
              {user ? (
                <>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 truncate">
                    {user.role || (user.email ? user.email.split('@')[0] : 'Guest')}
                  </p>
                </>
              ) : (
                <>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-1 px-2">
                ...
                <motion.button
                  ...
                  className="flex items-center w-full py-3 px-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors relative"
                >
                  <div className="w-8 h-8 flex items-center justify-center">
                    <NotificationsIcon className="text-gray-500" style={{ fontSize: '20px' }} />
                  </div>
                  <motion.span
                    initial={{ opacity: 0, x: -10 }}
                    animate={{ 
