...
import QuizIcon from '@mui/icons-material/Quiz';
import LibraryBooksIcon from '@mui/icons-material/LibraryBooks';
import { FlightTakeoff, SupportAgent, Link as LinkIcon } from '@mui/icons-material';
      ...
      >
        <div className="p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for your accommodation booking request. Our housing specialist will contact you within 24 hours to assist you with the next steps.
          </p>
    ...
    >
      ...
      >
        <div className="p-6 text-center">
          ...
          <p className="text-gray-600 mb-6">
            There was an issue submitting your booking request. Please try again or contact us directly for assistance.
          </p>
            ...
            <div>
              ...
              {selectedAccommodation && (
                <div className="mt-2 text-blue-600 font-medium">
                  {selectedAccommodation.name} - {selectedAccommodation.city}, {selectedAccommodation.country}
                </div>
              )}
            </div>
            <button
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <div className="flex items-center mt-2 space-x-4">
                <div className="flex items-center">
                  <LocationOnIcon className="h-5 w-5 text-gray-500 mr-2" />
                  <span className="text-gray-600">{accommodation.city}, {accommodation.country}</span>
                </div>
                <div className="flex items-center">
                  <SchoolIcon className="h-5 w-5 text-gray-500 mr-2" />
                  <span className="text-gray-600">{accommodation.university}</span>
                </div>
              </div>
            </div>
            <div className="flex space-x-2">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-green-50 p-4 rounded-xl">
                  ...
                  <p className="text-2xl font-bold text-green-700">{accommodation.price}</p>
                  <p className="text-sm text-gray-600 mt-1">{accommodation.utilitiesIncluded === 'Yes' ? 'All utilities included' : 'Partial utilities included'}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-xl">
                  <div className="flex items-center mb-2">
                    <BedIcon className="h-6 w-6 text-purple-600 mr-2" />
                  ...
                  <p className="text-2xl font-bold text-purple-700">{accommodation.bedrooms}</p>
                  <p className="text-sm text-gray-600 mt-1">Bathroom: {accommodation.bathrooms}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-5 rounded-xl">
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Minimum Stay</p>
                    <p className="font-semibold text-gray-900">{accommodation.minimumStay}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Contract Length</p>
                    <p className="font-semibold text-gray-900">{accommodation.contractLength}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Security Deposit</p>
                    <p className="font-semibold text-gray-900">{accommodation.deposit}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Availability</p>
                    <span className={`px-3 py-1 rounded-full text-sm font-bold ${
            ...
            <div>
              ...
              <div className="bg-gray-50 p-5 rounded-xl">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center">
                    <LinkIcon className="h-5 w-5 text-blue-500 mr-3" />
                    <a href={accommodation.bookingLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                      Official Booking Website
                    </a>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 p-5 rounded-xl">
                <div className="space-y-2">
                  <div className="flex items-start">
                    <LocationOnIcon className="h-5 w-5 text-red-500 mr-3 mt-0.5" />
                    <span className="text-gray-700">{accommodation.city}, {accommodation.country}</span>
                  </div>
                  <div className="flex items-start">
                    <DirectionsWalkIcon className="h-5 w-5 text-green-500 mr-3 mt-0.5" />
                    <span className="text-gray-700">{accommodation.distance} from {accommodation.university}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {!['China', 'Canada'].includes(currentCountry) && (
                <div className="bg-white p-4 rounded-lg col-span-2">
                  <h4 className="font-semibold text-gray-900 mb-2">General Tips for {currentCountry}</h4>
                  <ul className="text-sm text-gray-700 space-y-1">
                    <li>• Research local customs and etiquette before arrival</li>
