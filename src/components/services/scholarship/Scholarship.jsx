...
export const Scholarship = () => {
  ...
  useEffect(() => {
    applyFilters();
  }, [filters, searchQuery, sortBy, scholarships]);
  ...
  const applyFilters = () => {
    ...
    switch (sortBy) {
      case 'deadline':
        ...
        break;
      case 'funding-high':
        // Sort by funding amount (high to low)
        filtered.sort((a, b) => {
          const getAmount = (str) => {
  ...
  const handleApplicationSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`${API_BASE_URL}/scholarship-application`, {
        ...applicationForm,
  ...
  const ScholarshipDetailModal = () => {
    ...
    const isSaved = savedScholarships.includes(selectedScholarship.id);
    const daysUntilDeadline = Math.ceil((new Date(selectedScholarship.deadline) - new Date()) / (1000 * 60 * 60 * 24));
              ...
              <div>
                <div className="flex items-center space-x-2 mb-2">
                  <div className={`px-3 py-1 text-white text-sm font-bold rounded-full ${
                    selectedScholarship.type === 'Fully Funded' ? 'bg-green-600' : 'bg-blue-600'
                  }`}>
                ...
                <div className="flex items-center mt-2 space-x-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-600">{selectedScholarship.country}</span>
                  </div>
                  <div className="flex items-center">
                    <SchoolIcon className="h-5 w-5 text-gray-500 mr-2" />
                    <span className="text-gray-600">{selectedScholarship.studyLevel}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    The {selectedScholarship.title} is a prestigious scholarship program offered by {selectedScholarship.provider} 
                    for international students seeking to pursue {selectedScholarship.studyLevel.toLowerCase()} studies in {selectedScholarship.country}.
                  </p>
                  <div className="bg-blue-50 p-4 rounded-xl">
                    <h4 className="font-bold text-blue-800 mb-2">Provider: {selectedScholarship.provider}</h4>
                    <p className="text-blue-700">
                      {selectedScholarship.provider} is committed to promoting international education and cultural exchange through 
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-green-50 p-4 rounded-xl">
                    ...
                    <p className="text-2xl font-bold text-green-700">{selectedScholarship.fundingAmount}</p>
                ...
                <div className="bg-gray-50 p-5 rounded-xl">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{selectedScholarship.type}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600 mb-1">Study Level</p>
                      <p className="font-semibold text-gray-900">{selectedScholarship.studyLevel}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600 mb-1">Application Status</p>
                      <span className={`px-3 py-1 rounded-full text-sm font-bold ${
                        selectedScholarship.applicationStatus === 'open' 
                          ? 'bg-green-100 text-green-800' 
                          : 'bg-red-100 text-red-800'
                      }`}>
                        {selectedScholarship.applicationStatus.toUpperCase()}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <button
                  onClick={() => {
                    setApplicationForm(prev => ({
                      ...prev,
                      scholarshipInterest: selectedScholarship.title
                    }));
            ...
            <form onSubmit={handleApplicationSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setApplicationForm({...applicationForm, currentEducation: e.target.value})}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    required
                    value={applicationForm.targetProgram}
                    onChange={(e) => setApplicationForm({...applicationForm, targetProgram: e.target.value})}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200"
                  >
                ...
                <div>
                  ...
                  <input
                    type="text"
                    required
                    value={applicationForm.scholarshipInterest}
                    onChange={(e) => setApplicationForm({...applicationForm, scholarshipInterest: e.target.value})}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setFilters({...filters, fundingAmount: e.target.value})}
                className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200"
              >
            ...
            <div className="flex items-end">
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => setFilters({...filters, applicationStatus: e.target.checked ? 'open' : ''})}
            ...
            {['All Scholarships', 'Fully Funded', 'Government', 'University', 'Urgent Deadlines'].map((tab) => (
              <button
                ...
                onClick={() => {
                  setActiveTab(tab);
                  if (tab === 'Fully Funded') {
                    setFilters({...filters, scholarshipType: 'Fully Funded'});
                    ...
                    setFilters({...filters, deadline: 'Within 1 Month'});
                  } else {
                    setFilters({...filters, scholarshipType: '', deadline: ''});
                    setSearchQuery('');
                  }
                }}
      ...
      {/* Modals */}
      {selectedScholarship && <ScholarshipDetailModal />}
