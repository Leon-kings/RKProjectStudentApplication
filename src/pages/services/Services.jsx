...
//                   : `Your booking for ${selectedService?.title} has been saved locally. We'll sync it when connection is restored.`}
//               </p>
...
//                       </div>
//                       <div className="text-sm text-gray-600">USD Price</div>
//                     </div>
...
//         localStorage.getItem("pendingSubmissions") || "[]"
//       );
//       if (pendingSubmissions.length > 0 && apiStatus.isConnected) {
...
//   // Map budget to format
//   const mapBudgetToFormat = (budget) => {
//     const map = {
//       low: "$1,000 - $5,000",
//       medium: "$5,000 - $15,000",
//       high: "$15,000 - $30,000",
...
//           budget: mapBudgetToFormat(formData.budget),
//           requirements: formData.requirements?.trim() || "",
//           serviceId: selectedService.id,
//           serviceName: selectedService.title,
//           serviceCategory: selectedService.category,
//           servicePriceUSD: selectedService.price,
//           servicePriceRWF: selectedService.priceRWF,
//         };
...
//               submissionSuccess = true;
//               submissionMessage =
//                 "Form saved locally. We'll sync with the server when connection is restored.";
//             } else {
//               throw new Error("Failed to save data locally");
//             }
//           }
//         } else {
//           // API not connected, save to local storage
//           const savedLocally = saveToLocalStorage({
//             customer: formDataToSend,
//             service: {
//               id: selectedService.id,
...
//             submissionSuccess = true;
//             submissionMessage =
//               "No API connection detected. Form saved locally for later submission.";
//           } else {
//             throw new Error("Failed to save data locally");
//           }
//         }
...
//       }
//     },
//     [selectedService, formData, resetForm, apiStatus.isConnected]
//   );
