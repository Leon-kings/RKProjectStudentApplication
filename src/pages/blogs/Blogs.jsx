...
export const Blogs = () => {
  ...
  const blogCategories = [
    ...
    },
    {
      ...
      name: "Travel Tips",
      icon: FlightIcon,
      color: "bg-gradient-to-t from-indigo-500 to-blue-400",
      textColor: "text-white",
    },
    {
      id: "culture",
      name: "Culture",
      icon: PeopleIcon,
      color: "bg-gradient-to-t from-teal-500 to-green-400",
      textColor: "text-white",
    },
  ];

  // Button gradient colors based on functionality
  const buttonGradients = {
    // Primary action buttons
    primary: "bg-gradient-to-t from-blue-500 to-purple-400 hover:from-blue-600 hover:to-purple-500",
    secondary: "bg-gradient-to-t from-green-500 to-teal-400 hover:from-green-600 hover:to-teal-500",
    success: "bg-gradient-to-t from-emerald-500 to-green-400 hover:from-emerald-600 hover:to-green-500",
    
    // Interactive buttons
    like: "bg-gradient-to-t from-red-500 to-pink-400 hover:from-red-600 hover:to-pink-500",
    save: "bg-gradient-to-t from-blue-500 to-cyan-400 hover:from-blue-600 hover:to-cyan-500",
    comment: "bg-gradient-to-t from-indigo-500 to-blue-400 hover:from-indigo-600 hover:to-blue-500",
    
    // Neutral buttons
    neutral: "bg-gradient-to-t from-gray-100 to-gray-50 hover:from-gray-200 hover:to-gray-100",
    neutralActive: "bg-gradient-to-t from-gray-200 to-gray-100 hover:from-gray-300 hover:to-gray-200",
    
    // Pagination buttons
    pagination: "bg-gradient-to-t from-blue-500 to-purple-400 hover:from-blue-600 hover:to-purple-500",
    paginationNeutral: "bg-gradient-to-t from-gray-100 to-gray-50 hover:from-gray-200 hover:to-gray-100",
    
    // Modal close buttons
    close: "bg-gradient-to-t from-gray-100 to-gray-50 hover:from-gray-200 hover:to-gray-100",
    
    // Category filter buttons (inactive state)
    categoryInactive: "bg-gradient-to-t from-white to-gray-50 hover:from-gray-50 hover:to-gray-100",
  };
    ...
    return (
      ...
      >
        <div className="relative h-40 sm:h-44 md:h-48 overflow-hidden">
          ...
          <div className="absolute top-3 sm:top-4 left-3 sm:left-4">
            <div
              className={`px-2 sm:px-3 md:px-4 py-1 rounded-full text-xs sm:text-sm font-bold ${blogCategories.find((cat) => cat.id === (post.category || "all"))?.color || "bg-gradient-to-t from-blue-500 to-cyan-400"} text-white`}
            >
              <span className="hidden xs:inline">
                {blogCategories.find((cat) => cat.id === (post.category || "all"))?.name || "Article"}
              </span>
          ...
          <div className="absolute top-3 sm:top-4 right-3 sm:right-4 flex space-x-1 sm:space-x-2">
            <button
              ...
              className={`p-1.5 sm:p-2 ${buttonGradients.neutral} backdrop-blur-sm rounded-full transition-colors`}
            >
              {isSaved ? (
                <BookmarkIcon className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600" />
              ) : (
        ...
        >
          <div className="p-4 sm:p-6 md:p-8">
            <div className="flex justify-between items-start mb-6 md:mb-8">
              <div>
                <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                  <div className={`p-1.5 sm:p-2 rounded-lg ${blogCategories.find((cat) => cat.id === (selectedPost.category || "all"))?.color || "bg-gradient-to-t from-blue-500 to-cyan-400"}`}>
                    <CategoryIcon className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                  </div>
                  <span className="text-sm font-semibold text-gray-800">
                    {blogCategories.find((cat) => cat.id === (selectedPost.category || "all"))?.name || "Article"}
                  ...
                  {selectedPost.featured && (
                    <span className="px-2 py-1 sm:px-3 sm:py-1 bg-gradient-to-t from-yellow-400 to-yellow-300 text-yellow-800 rounded-full text-xs sm:text-sm font-bold">
                      Featured
                    </span>
                  )}
                </div>
              ...
              <button
                onClick={closeBlogModal}
                className={`p-1 sm:p-2 ${buttonGradients.close} rounded-full transition-colors`}
              >
                <CloseIcon className="h-5 w-5 sm:h-7 sm:w-7 text-gray-700" />
              </button>
            </div>
            ...
            <div className="mb-6 md:mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {selectedPost.formattedTags.map((tag, index) => (
                  <span
                    key={index}
                    className="px-2 sm:px-3 md:px-4 py-1 sm:py-2 bg-gradient-to-t from-blue-50 to-blue-100 text-blue-700 font-semibold text-sm rounded-full"
                  >
                    #{tag}
                  </span>
                ))}
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-6 sm:pt-8 border-t border-gray-200 space-y-4 sm:space-y-0">
              <div className="flex flex-wrap gap-2 sm:gap-4">
                <button
                  onClick={() => toggleLikePost(selectedPost._id)}
                  className={`px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-xl flex items-center space-x-1 sm:space-x-2 text-sm sm:text-base ${likedPosts.includes(selectedPost._id) ? buttonGradients.like : buttonGradients.neutral} text-white`}
                >
                  {likedPosts.includes(selectedPost._id) ? (
                    <FavoriteIcon className="h-4 w-4 sm:h-5 sm:w-5" />
                  ) : (
                ...
                <button
                  onClick={() => toggleSavePost(selectedPost._id)}
                  className={`px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-xl flex items-center space-x-1 sm:space-x-2 text-sm sm:text-base ${savedPosts.includes(selectedPost._id) ? buttonGradients.save : buttonGradients.neutral} text-white`}
                >
                  {savedPosts.includes(selectedPost._id) ? (
                    <BookmarkIcon className="h-4 w-4 sm:h-5 sm:w-5" />
                  ) : (
                ...
                <button
                  onClick={() => handleLoadComments(selectedPost._id)}
                  className={`px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-xl flex items-center space-x-1 sm:space-x-2 text-sm sm:text-base ${buttonGradients.neutral} text-gray-800`}
                >
                  <CommentIcon className="h-4 w-4 sm:h-5 sm:w-5" />
                  <span>Comment ({selectedPost.comments || 0})</span>
                </button>
              ...
              <button
                onClick={() => setBookingModalOpen(true)}
                className={`px-4 sm:px-5 md:px-6 py-2.5 sm:py-3 ${buttonGradients.primary} text-white rounded-xl hover:shadow-lg transition-all duration-300 text-sm sm:text-base`}
              >
                Book Free Consultation
              </button>
            </div>
        ...
        >
          <div className="p-4 sm:p-6 md:p-8">
            ...
            >
              ...
              <button
                type="submit"
                className={`w-full py-2.5 sm:py-3 md:py-4 ${buttonGradients.primary} text-white font-bold rounded-xl hover:shadow-lg transition-all duration-300 text-sm sm:text-base`}
              >
                Submit Booking Request
              </button>
            </form>
      ...
      >
        ...
        >
          <div className="p-4 sm:p-6 md:p-8">
            ...
            <div className="mb-6 md:mb-8">
              <div className="flex items-start space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-t from-blue-500 to-purple-400 rounded-full flex items-center justify-center text-white font-bold text-sm sm:text-base">
                  U
                </div>
                <div className="flex-1">
                  <textarea
                  ...
                  <div className="flex justify-end mt-2">
                    <button
                      onClick={handleCommentSubmit}
                      disabled={!newComment.trim()}
                      className={`px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 rounded-xl flex items-center space-x-1 sm:space-x-2 text-sm sm:text-base ${newComment.trim() ? buttonGradients.primary : buttonGradients.neutral} ${newComment.trim() ? 'text-white hover:shadow-lg' : 'text-gray-500 cursor-not-allowed'} transition-all duration-300`}
                    >
                      <SendIcon className="h-4 w-4 sm:h-5 sm:w-5" />
                      <span>Post Comment</span>
                    </button>
              ...
              {currentComments.length === 0 ? (
                ...
                currentComments.map((comment) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2 sm:mb-3">
                      <div className="flex items-center space-x-2 sm:space-x-3">
                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-t from-blue-400 to-cyan-300 rounded-full flex items-center justify-center text-white font-bold text-xs sm:text-sm">
                          {(comment.author || "User").charAt(0)}
                        </div>
                        <div>
                          <div className="font-semibold text-sm sm:text-base text-gray-900">
                      ...
                      <button
                        onClick={() => handleCommentLike(comment._id || comment.id)}
                        className={`flex items-center space-x-1 ${buttonGradients.close} rounded-full px-2 py-1 transition-colors`}
                      >
                        {comment.userLiked ? (
                          <ThumbUpIcon className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600" />
                        ) : (
                    ...
                    <div className="flex space-x-3 sm:space-x-4 mt-2 pt-2 sm:pt-3 border-t border-gray-100">
                      <button className={`text-xs sm:text-sm text-gray-700 hover:text-blue-600 transition-colors px-2 py-1 ${buttonGradients.close} rounded`}>
                        Reply
                      </button>
                      <button className={`text-xs sm:text-sm text-gray-700 hover:text-red-600 transition-colors px-2 py-1 ${buttonGradients.close} rounded`}>
                        Report
                      </button>
                    </div>
                  </div>
    ...
    return (
      ...
      >
        <div className="flex items-start space-x-2 sm:space-x-3">
          ...
          <div className="flex-1">
            <div className="flex items-center space-x-1 sm:space-x-2 mb-1 sm:mb-2">
              <div className="p-1 bg-gradient-to-t from-gray-100 to-gray-50 rounded">
                <CategoryIcon className="h-3 w-3 sm:h-4 sm:w-4 text-gray-700" />
              </div>
              <span className="text-xs font-semibold text-gray-700 uppercase">
                {blogCategories.find((cat) => cat.id === (post.category || "all"))?.name || "Article"}
    ...
    return (
      <div className="flex items-center justify-center space-x-1 sm:space-x-2 mt-6 sm:mt-8">
        <button
          onClick={() => handlePageChange(1)}
          disabled={currentPage === 1}
          className={`p-1.5 sm:p-2 rounded-lg ${currentPage === 1 ? 'text-gray-500 cursor-not-allowed' : buttonGradients.close + ' text-gray-800'}`}
        >
          <FirstPageIcon className="h-4 w-4 sm:h-5 sm:w-5" />
        </button>
        ...
        {pages.map((page) => (
          <button
            key={page}
            onClick={() => handlePageChange(page)}
            className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg font-semibold text-sm sm:text-base ${currentPage === page ? buttonGradients.pagination + ' text-white' : buttonGradients.close + ' text-gray-800'}`}
          >
            {page}
          </button>
        ))}
        ...
        <button
          onClick={() => handlePageChange(currentPage + 1)}
          disabled={currentPage === totalPages}
          className={`p-1.5 sm:p-2 rounded-lg ${currentPage === totalPages ? 'text-gray-500 cursor-not-allowed' : buttonGradients.close + ' text-gray-800'}`}
        >
          <ArrowForwardIosOutlined className="h-4 w-4 sm:h-5 sm:w-5" />
        </button>
  ...
  const AboutUsSection = () => {
    return (
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ delay: 0.9 }}
        className="bg-gradient-to-t from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-5 md:p-6 border border-blue-100"
      >
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 flex items-center">
            <BusinessIcon className="mr-2 h-5 w-5 sm:h-6 sm:w-6 text-blue-600" />
          ...
          <button
            onClick={() => setShowAboutUs(false)}
            className={`p-1 ${buttonGradients.close} rounded-full transition-colors`}
          >
            <CloseIcon className="h-5 w-5 text-blue-600" />
          </button>
        </div>
        ...
        <button
          onClick={() => setBookingModalOpen(true)}
          className={`w-full mt-4 py-3 ${buttonGradients.secondary} text-white font-bold rounded-lg hover:shadow-lg transition-all duration-300 text-sm sm:text-base flex items-center justify-center`}
        >
          <SchoolIcon className="mr-2 h-5 w-5" />
          Start Your Study Abroad Journey Today
        </button>
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-t from-blue-800 to-indigo-500 text-white py-6 sm:py-8 md:py-12 px-3 sm:px-4 md:px-6 lg:px-8">
        <ToastContainer
          position="top-right"
          autoClose={3000}
          hideProgressBar={false}
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                animate={{ scaleX: 1 }}
                transition={{ duration: 1, delay: 1, ease: "easeInOut" }}
                className="absolute -bottom-2 sm:-bottom-3 left-0 right-0 h-2 sm:h-3 bg-gradient-to-t from-green-400 via-blue-400 to-purple-400 origin-left transform -skew-x-12"
                style={{ transformOrigin: "left" }}
              />
            </motion.div>
            ...
            >
              ...
              <motion.span
                ...
                animate={{ backgroundSize: "100% 100%" }}
                transition={{ delay: 1.5, duration: 1.5 }}
                className="bg-gradient-to-t from-green-500 to-blue-500 bg-clip-text text-transparent font-bold mx-1 sm:mx-2"
                style={{
                  backgroundImage:
            ...
            >
              <button
                onClick={() => setShowAboutUs(!showAboutUs)}
                className={`inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 ${buttonGradients.primary} text-white font-semibold rounded-full hover:shadow-lg transition-all duration-300 text-sm sm:text-base`}
              >
                <BusinessIcon className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
                {showAboutUs ? "Hide About Us" : "Learn About RECAPPLY"}
                <ArrowForwardIcon className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
              ...
              {blogCategories.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-full font-bold transition-all duration-300 transform hover:-translate-y-0.5 sm:hover:-translate-y-1 flex items-center space-x-1.5 sm:space-x-2 md:space-x-3 text-xs sm:text-sm md:text-base ${
                      activeCategory === category.id
                        ? `${category.color} text-white shadow-lg sm:shadow-xl`
                        : `${buttonGradients.categoryInactive} text-gray-800 border border-gray-300 sm:border-2 hover:border-blue-300`
                    }`}
                  >
                    <Icon className="h-4 w-4 sm:h-5 sm:w-5" />
                    <span className="whitespace-nowrap">{category.name}</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.8 }}
                className="bg-gradient-to-t from-blue-500 to-purple-400 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-white"
              >
                <h3 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6">
                  Browse by Category
                </h3>
                  ...
                  {blogCategories.slice(1).map((category) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center justify-between w-full p-2 sm:p-3 ${buttonGradients.categoryInactive} hover:bg-white/20 rounded-lg sm:rounded-xl transition-colors text-white`}
                      >
                        <div className="flex items-center space-x-2 sm:space-x-3">
                          <Icon className="h-4 w-4 sm:h-5 sm:w-5" />
                          <span className="text-sm sm:text-base">
                        ...
                        <span className={`px-2 py-0.5 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm ${buttonGradients.neutral}`}>
                          {Math.floor(Math.random() * 20) + 5}
                        </span>
                      </button>
                    );
