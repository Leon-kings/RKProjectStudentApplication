...
export const Blogs = () => {
  ...
  const countryImages = {
    china: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=800&q=80', // Great Wall
    india: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=800&q=80', // Taj Mahal
    japan: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=800&q=80', // Tokyo city
    korea: 'https://images.unsplash.com/photo-1534274988757-a28bf1a57c17?auto=format&fit=crop&w=800&q=80', // Seoul
    canada: 'https://images.unsplash.com/photo-1519677100203-7c61d0b01354?auto=format&fit=crop&w=800&q=80', // Canadian landscape
    germany: 'https://images.unsplash.com/photo-1528728329032-2972f65dfb3f?auto=format&fit=crop&w=800&q=80', // Berlin
    usa: 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?auto=format&fit=crop&w=800&q=80', // New York
    poland: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?auto=format&fit=crop&w=800&q=80', // Warsaw
    turkey: 'https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?auto=format&fit=crop&w=800&q=80', // Istanbul
  };

  // Service images for About Us section
  const serviceImages = {
    admissions: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=600&q=80',
    csca: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=600&q=80',
    scholarship: 'https://images.unsplash.com/photo-1579621970795-87facc2f976d?auto=format&fit=crop&w=600&q=80',
    documents: 'https://images.unsplash.com/photo-1586282023697-bdaf0953e627?auto=format&fit=crop&w=600&q=80',
    visa: 'https://images.unsplash.com/photo-1580519542036-c47de6196ba5?auto=format&fit=crop&w=600&q=80',
    predeparture: 'https://images.unsplash.com/photo-1529472119196-cb724127a98e?auto=format&fit=crop&w=600&q=80',
    partnerships: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=600&q=80',
  };
  ...
  const services = [
    { id: 1, name: 'University Admissions', icon: SchoolOutlinedIcon, description: 'Choose best country, university & major based on your goals', image: serviceImages.admissions },
    { id: 2, name: 'CSCA Exam Preparation', icon: DescriptionOutlinedIcon, description: 'Full support for China Scholastic Competency Assessment', image: serviceImages.csca },
    { id: 3, name: 'Scholarship Guidance', icon: AttachMoneyIcon, description: 'Access fully funded & partial scholarships worldwide', image: serviceImages.scholarship },
    { id: 4, name: 'Documents Preparation', icon: DescriptionIcon, description: 'Professional SOP, CV, study plans & reference letters', image: serviceImages.documents },
    { id: 5, name: 'Visa Assistance', icon: FlightTakeoffIcon, description: 'Step-by-step visa support & interview preparation', image: serviceImages.visa },
    { id: 6, name: 'Pre-Departure Guidance', icon: FlightIcon, description: 'Accommodation, travel, cultural adaptation support', image: serviceImages.predeparture },
    { id: 7, name: 'Institutional Partnerships', icon: HandshakeIcon, description: 'University partnerships for student recruitment', image: serviceImages.partnerships },
  ];
      ...
      try {
        ...
        const samplePosts = [
          ...
          },
          {
            ...
            excerpt: "Understanding Japanese culture, etiquette, and tips for international students to adapt quickly.",
          ...
          },
          {
            ...
            excerpt: "Essential travel tips for students moving to Asian countries for studies.",
          ...
          },
          {
            ...
            excerpt: "Everything you need to know about the China Scholastic Competency Assessment for undergraduate admissions.",
          ...
          {
            id: 7,
            title: "Scholarship Application Strategies for International Students",
            excerpt: "Proven strategies to secure scholarships for studying abroad in 2024.",
          ...
          {
            id: 8,
            title: "Indian Education System: A Guide for International Students",
            excerpt: "Understanding the Indian higher education system and admission process.",
        ...
        const generatedPosts = Array.from({ length: 22 }, (_, index) => {
          ...
          const category = ["admissions", "visa", "accommodation", "travel", "culture"][index % 5];
          const categoryImagesArray = categoryImages[category] || categoryImages.all;
          ...
          return {
            ...
            excerpt: `Essential guide and tips for international students considering ${["Canada", "Australia", "Japan", "Thailand", "global travel", "applications", "Europe", "work", "healthcare", "networking", "returning home", "digital lifestyle", "sustainable travel", "emergency situations", "financial management", "mental wellbeing", "internships", "career development", "summer programs", "research", "online education", "cultural exchange"][index]}.`,
            content: `<h2>Detailed Guide</h2><p>Comprehensive information and expert advice...</p>`,
            author: "Expert Author",
            date: new Date(2024, 1, index + 1).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }),
            readTime: `${Math.floor(Math.random() * 10) + 5} min read`,
            category: category,
            tags: [
      ...
      >
        ...
        >
          <div className="p-4 sm:p-6 md:p-8">
            <div className="flex justify-between items-center mb-6 md:mb-8">
              <div>
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Book Free Consultation</h2>
                <p className="text-gray-600 mt-1 sm:mt-2 text-sm sm:text-base">Get expert advice for your study abroad journey</p>
              </div>
              <button
                onClick={() => setBookingModalOpen(false)}
    ...
    return (
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6">
          <div className="bg-white p-4 sm:p-5 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700 text-sm sm:text-base">
              We support students from Africa and beyond to secure <strong>admissions, scholarships, and visas</strong> to top universities worldwide including China, Canada, Poland, Turkey, Germany, the USA, and many others.
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-5 mb-6">
          <h4 className="font-bold text-purple-700 mb-4 text-sm sm:text-base">Our Services</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {services.map((service) => {
              const Icon = service.icon;
              return (
                <div key={service.id} className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow duration-200">
                  <div className="flex items-start space-x-3">
                    <div className="p-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg">
                      <Icon className="h-5 w-5 text-white" />
                    </div>
                    <div>
                      <h5 className="font-semibold text-gray-800 text-sm sm:text-base mb-1">{service.name}</h5>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6">
          <div className="bg-white p-4 sm:p-5 rounded-lg shadow-sm">
            <h4 className="font-bold text-green-700 mb-3 text-sm sm:text-base">Why Choose RECAPPLY</h4>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              <li className="flex items-start">
                <span className="text-green-500 mr-2 mt-1">✓</span>
                <span><strong>High success rate:</strong> Excellent admission & visa approval record</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2 mt-1">✓</span>
                <span><strong>Transparent process:</strong> Clear, honest communication at every step</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2 mt-1">✓</span>
                <span><strong>Professional documents:</strong> Expertly crafted SOPs, CVs, and study plans</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2 mt-1">✓</span>
                <span><strong>Personalized support:</strong> Dedicated consultant for each student</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2 mt-1">✓</span>
                <span><strong>CSCA expertise:</strong> Specialized support for China entry requirements</span>
              </li>
            </ul>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm sm:text-base">
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <a href="mailto:r.educationalconsultance@gmail.com" className="hover:underline break-all">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <span>Kigali – Kicukiro Centre, Sangwa Plaza, 1st Floor, R6 Door</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            {posts.length === 0 ? (
              ...
              <>
                ...
                >
                  {posts.map((post, index) => (
                    <BlogCard key={post.id} post={post} variant={post.featured ? 'featured' : 'normal'} />
                  ))}
                </motion.div>
